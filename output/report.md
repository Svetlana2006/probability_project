...
## Dataset Snapshot
- Cleaned chart rows: 550
- Unique chart dates: 11
...
## Notes
- Genre metadata matched for 128 of 550 chart rows.
...
- 30.49% of observed spells start on the first chart date in the dataset, so some song lifetimes may be left-truncated.
- Pareto provides the lower AIC for artist appearance counts in this sample.
- Top 3 artists account for 10.55% of all Top 50 chart slots in the dataset.
- The artist-appearance Gini coefficient is 0.4107.
...
- Generated future Top 10 predictions for the latest data (2026-03-25).
...
- Rank Changes: Kolmogorov-Smirnov -> Reject H0 (p=0.000000)
- Survival: Likelihood Ratio Test (Exponential vs Weibull) -> Reject H0 (p=0.022502)
- New Entries: Chi-square goodness of fit -> Reject H0 (p=0.000000)
- New Entries: Two-sample Poisson rate z-test -> Reject H0 (p=0.003589)
